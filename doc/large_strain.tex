...
On the coarsest level we use {\color{red}the Chebyshev preconditioner as a solver \cite{Varga1999}} to reduce the residual by three orders of magnitude.
{\color{red}Maximum and minimum eigenvalues at this level are estimated from the CG solver set to reduce the residual by $10$ orders of magnitude within (at most) as many
iterations as the coarse level problem size.\todo{remove if we do 30}}
