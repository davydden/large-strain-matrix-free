...
`read / write' steps takes a negligible amount of time on each element.
...
{\color{red} demonstrate the same behavior of the number of CG iterations, but}
...
On the other hand, the wall time of the matrix-based iterative solver grows rapidly with increasing polynomial degree.
...
Based on these results, we conclude that the matrix-free approach with the adopted here geometric multigrid preconditioner can deliver a very competitive solution strategy for solid mechanics problems
