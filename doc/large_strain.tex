...
The main reason is that, apart from the point-wise computation of the stresses and corresponding tangent operators, the operations are typically the same on all elements{\color{red},
