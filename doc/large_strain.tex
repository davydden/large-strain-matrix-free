...
First, is the higher algorithmic intensity as compared to the matrix-based implementation, which is clearly a memory
bound, see Figure XXXX.
...
Section \ref{sec:mf} and in the reference \cite{kronbichler12}.
}
