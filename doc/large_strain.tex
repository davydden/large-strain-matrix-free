...
Section \ref{sec: Constitutive modelling}, has been implemented using\footnote{{\color{red}Including additional performance improvements for \texttt{Tensor} classes \url{https://github.com/dealii/dealii/pull/8428}.}} \texttt{deal.II} version 9.1 \cite{dealII91}, an open-source finite element library.
