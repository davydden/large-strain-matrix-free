...
the elements are first according to the material type (matrix or inclusion) and then the SIMD vectorization is applied for each group of elements.
...
which increases the memory consumption makes element operations more expensive.
Nonetheless }
...
70\% reported for the Laplace operation in \cite{kronbichler12}.
