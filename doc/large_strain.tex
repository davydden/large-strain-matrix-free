...
As expected, the matrix-based approach is memory bound and (on average) achieves the performance of $8.5\,\rm{GFlop/s}$.
...
This indicates the origin for suboptimal results of matrix-free approach is most likely not related to the algorithms studied here.
