...
\end{align*}
%
{\color{red} Daniel: please adjust the discussion above, I think we need to add more on what happens with those 4 loops}
In general, this reordering reduces the arithmetic complexity to $\mathcal{O}(dn^{d+1})$ and is called sum factorization.
