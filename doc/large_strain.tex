...
\begin{frontmatter}
  \title{
  Large-strain matrix-free finite element solver of hyperelastic problems with geometric multigrid preconditioner
  }
  ...
  \begin{abstract}
    Solution of source problems on modern computer architectures is typically memory banded.
    ...
    We propose and numerically investigate different implementations of the large-strain hyper-elastic tangent operator.
    In order to improve the convergence of iterative solvers, we also propose a way to construct a level tangent operator
    and employ it to define a geometric multigrid preconditioner.
