...
Sections \ref{sec:fe} cover the finite element discretization.
In \ref{sec:mf} we describe the different matrix-free operator implementations that are evaluated in this study.
