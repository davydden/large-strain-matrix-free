...
In practise this implies that parallelization of the assembly operation (for the matrix-based approach) and the linear solver (as well as various pre- and post-processing steps), both of which are the focal points of discussion in this manuscript, has been achieved using MPI.
