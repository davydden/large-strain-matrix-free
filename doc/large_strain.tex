...
\fi
  ...
  \begin{abstract}
    ...
    \changeJP{To date, there have been few assessments into the applicability of the matrix-free approach to problems in solid mechanics.
...
{\color{red} which is also limited to small strain linear elasticity.}\todo{omit?}
...
This can potentially reduce the advantage of matrix-free methods, that are generally more competitive for higher order elements\todo{reference?}.
