...
In \ref{sec:mf} we describe the different matrix-free operator implementation approaches that are evaluated in this study, and in section \ref{sec:gmg} we propose a geometric multigrid preconditioner that is suitable for matrix-free implementation of finite-strain hyperelasticity.
}
