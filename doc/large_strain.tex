...
configurations, and therefore two inverses will be cached via two different \textit{MatrixFree} objects.\todo{rerun IWR}\todo{this is roughly main memory transfer, do we elaborate on this/use it?}}
