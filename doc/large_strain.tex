...
The measurements are done on a single socket of RRZE cluster by pinning all 10 MPI processes to this socket.
Its memory bandwidth and peak performance are $B=50 \,\rm{GB/s}$ and $P=176\, \rm{GFLOP/s}$, respectively.
